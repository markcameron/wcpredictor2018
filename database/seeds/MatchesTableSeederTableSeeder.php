  ...
  public function run() {
    ...
    $matches = [
      ...
      [
        ...
        'date' => Carbon::create(2018, 6, 14, 18, 0, 0, 3)->timezone('UTC')->toDateTimeString(),
      ],

      // 15th June
      [
        'home_team_id' => $teams->where('name', 'Egypt')->first()->id,
        'away_team_id' => $teams->where('name', 'Uruguay')->first()->id,
        'stadium_id' => $stadiums->where('name', 'Central Stadium')->first()->id,
        'date' => Carbon::create(2018, 6, 15, 15, 0, 0, 4)->timezone('UTC')->toDateTimeString(),
      ],
      [
        'home_team_id' => $teams->where('name', 'Morocco')->first()->id,
        'away_team_id' => $teams->where('name', 'Iran')->first()->id,
        'stadium_id' => $stadiums->where('name', 'Krestovsky Stadium')->first()->id,
        'date' => Carbon::create(2018, 6, 15, 18, 0, 0, 3)->timezone('UTC')->toDateTimeString(),
      ],
      [
        ...
        'date' => Carbon::create(2018, 6, 15, 21, 0, 0, 3)->timezone('UTC')->toDateTimeString(),
      ],
      ...
      [
        ...
        'date' => Carbon::create(2018, 6, 16, 13, 0, 0, 3)->timezone('UTC')->toDateTimeString(),
      ],
      [
        ...
        'date' => Carbon::create(2018, 6, 16, 19, 0, 0, 3)->timezone('UTC')->toDateTimeString(),
      ],
      [
        ...
        'date' => Carbon::create(2018, 6, 16, 16, 0, 0, 3)->timezone('UTC')->toDateTimeString(),
      ],
      [
        ...
        'date' => Carbon::create(2018, 6, 16, 21, 0, 0, 3)->timezone('UTC')->toDateTimeString(),
      ],
      ...
      [
        ...
        'date' => Carbon::create(2018, 6, 17, 16, 0, 0, 4)->timezone('UTC')->toDateTimeString(),
      ],
      [
        ...
        'date' => Carbon::create(2018, 6, 17, 21, 0, 0, 3)->timezone('UTC')->toDateTimeString(),
      ],
      [
        'home_team_id' => $teams->where('name', 'Germany')->first()->id,
        'away_team_id' => $teams->where('name', 'Mexico')->first()->id,
        'stadium_id' => $stadiums->where('name', 'Luzhniki Stadium')->first()->id,
        'date' => Carbon::create(2018, 6, 17, 18, 0, 0, 3)->timezone('UTC')->toDateTimeString(),
      ],
      ...
      [
        ...
        'stadium_id' => $stadiums->where('name', 'Luzhniki Stadium')->first()->id,
        'date' => Carbon::create(2018, 6, 18, 15, 0, 0, 4)->timezone('UTC')->toDateTimeString(),
      ],
      [
        'home_team_id' => $teams->where('name', 'Belgium')->first()->id,
        'away_team_id' => $teams->where('name', 'Panama')->first()->id,
        'stadium_id' => $stadiums->where('name', 'Fisht Olympic Stadium')->first()->id,
        'date' => Carbon::create(2018, 6, 18, 18, 0, 0, 3)->timezone('UTC')->toDateTimeString(),
      ],
      [
        ...
        'date' => Carbon::create(2018, 6, 18, 21, 0, 0, 3)->timezone('UTC')->toDateTimeString(),
      ],
      ...
      [
        ...
        'stadium_id' => $stadiums->where('name', 'Mordovia Arena')->first()->id,
        'date' => Carbon::create(2018, 6, 19, 15, 0, 0, 3)->timezone('UTC')->toDateTimeString(),
      ],
      [
        'home_team_id' => $teams->where('name', 'Poland')->first()->id,
        'away_team_id' => $teams->where('name', 'Senegal')->first()->id,
        'stadium_id' => $stadiums->where('name', 'Otkritie Arena')->first()->id,
        'date' => Carbon::create(2018, 6, 19, 18, 0, 0, 3)->timezone('UTC')->toDateTimeString(),
      ],
      ...
      [
        ...
        'stadium_id' => $stadiums->where('name', 'Krestovsky Stadium')->first()->id,
        'date' => Carbon::create(2018, 6, 19, 21, 0, 0, 3)->timezone('UTC')->toDateTimeString(),
      ],
      ...
      [
        ...
        'away_team_id' => $teams->where('name', 'Saudi Arabia')->first()->id,
        'stadium_id' => $stadiums->where('name', 'Rostov Arena')->first()->id,
        'date' => Carbon::create(2018, 6, 20, 18, 0, 0, 3)->timezone('UTC')->toDateTimeString(),
      ],
      [
        'home_team_id' => $teams->where('name', 'Portugal')->first()->id,
        'away_team_id' => $teams->where('name', 'Morocco')->first()->id,
        'stadium_id' => $stadiums->where('name', 'Luzhniki Stadium')->first()->id,
        'date' => Carbon::create(2018, 6, 20, 15, 0, 0, 3)->timezone('UTC')->toDateTimeString(),
      ],
      [
        'home_team_id' => $teams->where('name', 'Iran')->first()->id,
        'away_team_id' => $teams->where('name', 'Spain')->first()->id,
        'stadium_id' => $stadiums->where('name', 'Kazan Arena')->first()->id,
        'date' => Carbon::create(2018, 6, 20, 21, 0, 0, 3)->timezone('UTC')->toDateTimeString(),
      ],
      ...
      [
        ...
        'away_team_id' => $teams->where('name', 'Australia')->first()->id,
        'stadium_id' => $stadiums->where('name', 'Cosmos Arena')->first()->id,
        'date' => Carbon::create(2018, 6, 21, 16, 0, 0, 4)->timezone('UTC')->toDateTimeString(),
      ],
      [
        'home_team_id' => $teams->where('name', 'France')->first()->id,
        'away_team_id' => $teams->where('name', 'Peru')->first()->id,
        'stadium_id' => $stadiums->where('name', 'Central Stadium')->first()->id,
        'date' => Carbon::create(2018, 6, 21, 19, 0, 0, 4)->timezone('UTC')->toDateTimeString(),
      ],
      [
        'home_team_id' => $teams->where('name', 'Argentina')->first()->id,
        'away_team_id' => $teams->where('name', 'Croatia')->first()->id,
        'stadium_id' => $stadiums->where('name', 'Nizhny Novgorod Stadium')->first()->id,
        'date' => Carbon::create(2018, 6, 21, 21, 0, 0, 3)->timezone('UTC')->toDateTimeString(),
      ],
      ...
      [
        ...
        'away_team_id' => $teams->where('name', 'Iceland')->first()->id,
        'stadium_id' => $stadiums->where('name', 'Volgograd Arena')->first()->id,
        'date' => Carbon::create(2018, 6, 22, 18, 0, 0, 3)->timezone('UTC')->toDateTimeString(),
      ],
      [
        'home_team_id' => $teams->where('name', 'Brazil')->first()->id,
        'away_team_id' => $teams->where('name', 'Costa Rica')->first()->id,
        'stadium_id' => $stadiums->where('name', 'Krestovsky Stadium')->first()->id,
        'date' => Carbon::create(2018, 6, 22, 15, 0, 0, 3)->timezone('UTC')->toDateTimeString(),
      ],
      [
        'home_team_id' => $teams->where('name', 'Serbia')->first()->id,
        'away_team_id' => $teams->where('name', 'Switzerland')->first()->id,
        'stadium_id' => $stadiums->where('name', 'Kaliningrad Stadium')->first()->id,
        'date' => Carbon::create(2018, 6, 22, 20, 0, 0, 2)->timezone('UTC')->toDateTimeString(),
      ],
      ...
      [
        ...
        'away_team_id' => $teams->where('name', 'Mexico')->first()->id,
        'stadium_id' => $stadiums->where('name', 'Rostov Arena')->first()->id,
        'date' => Carbon::create(2018, 6, 23, 18, 0, 0, 3)->timezone('UTC')->toDateTimeString(),
      ],
      [
        'home_team_id' => $teams->where('name', 'Germany')->first()->id,
        'away_team_id' => $teams->where('name', 'Sweden')->first()->id,
        'stadium_id' => $stadiums->where('name', 'Fisht Olympic Stadium')->first()->id,
        'date' => Carbon::create(2018, 6, 23, 21, 0, 0, 3)->timezone('UTC')->toDateTimeString(),
      ],
      [
        'home_team_id' => $teams->where('name', 'Belgium')->first()->id,
        'away_team_id' => $teams->where('name', 'Tunisia')->first()->id,
        'stadium_id' => $stadiums->where('name', 'Otkritie Arena')->first()->id,
        'date' => Carbon::create(2018, 6, 23, 15, 0, 0, 3)->timezone('UTC')->toDateTimeString(),
      ],
      ...
      [
        ...
        'away_team_id' => $teams->where('name', 'Panama')->first()->id,
        'stadium_id' => $stadiums->where('name', 'Nizhny Novgorod Stadium')->first()->id,
        'date' => Carbon::create(2018, 6, 24, 15, 0, 0, 3)->timezone('UTC')->toDateTimeString(),
      ],
      [
        'home_team_id' => $teams->where('name', 'Japan')->first()->id,
        'away_team_id' => $teams->where('name', 'Senegal')->first()->id,
        'stadium_id' => $stadiums->where('name', 'Central Stadium')->first()->id,
        'date' => Carbon::create(2018, 6, 24, 19, 0, 0, 4)->timezone('UTC')->toDateTimeString(),
      ],
      [
        'home_team_id' => $teams->where('name', 'Poland')->first()->id,
        'away_team_id' => $teams->where('name', 'Colombia')->first()->id,
        'stadium_id' => $stadiums->where('name', 'Kazan Arena')->first()->id,
        'date' => Carbon::create(2018, 6, 24, 21, 0, 0, 3)->timezone('UTC')->toDateTimeString(),
      ],
      ...
      [
        ...
        'stadium_id' => $stadiums->where('name', 'Cosmos Arena')->first()->id,
        'date' => Carbon::create(2018, 6, 25, 18, 0, 0, 4)->timezone('UTC')->toDateTimeString(),
      ],
      [
        'home_team_id' => $teams->where('name', 'Saudi Arabia')->first()->id,
        'away_team_id' => $teams->where('name', 'Egypt')->first()->id,
        'stadium_id' => $stadiums->where('name', 'Volgograd Arena')->first()->id,
        'date' => Carbon::create(2018, 6, 25, 17, 0, 0, 3)->timezone('UTC')->toDateTimeString(),
      ],
      [
        'home_team_id' => $teams->where('name', 'Iran')->first()->id,
        'away_team_id' => $teams->where('name', 'Portugal')->first()->id,
        'stadium_id' => $stadiums->where('name', 'Mordovia Arena')->first()->id,
        'date' => Carbon::create(2018, 6, 25, 21, 0, 0, 3)->timezone('UTC')->toDateTimeString(),
      ],
      [
        'home_team_id' => $teams->where('name', 'Spain')->first()->id,
        'away_team_id' => $teams->where('name', 'Morocco')->first()->id,
        'stadium_id' => $stadiums->where('name', 'Kazan Arena')->first()->id,
        'date' => Carbon::create(2018, 6, 25, 20, 0, 0, 2)->timezone('UTC')->toDateTimeString(),
      ],
      ...
      [
        ...
        'stadium_id' => $stadiums->where('name', 'Luzhniki Stadium')->first()->id,
        'date' => Carbon::create(2018, 6, 26, 17, 0, 0, 3)->timezone('UTC')->toDateTimeString(),
      ],
      [
      ...
      [
        ...
        'stadium_id' => $stadiums->where('name', 'Krestovsky Stadium')->first()->id,
        'date' => Carbon::create(2018, 6, 26, 21, 0, 0, 3)->timezone('UTC')->toDateTimeString(),
      ],
      [
      ...
      [
        ...
        'stadium_id' => $stadiums->where('name', 'Otkritie Arena')->first()->id,
        'date' => Carbon::create(2018, 6, 27, 21, 0, 0, 3)->timezone('UTC')->toDateTimeString(),
      ],
      [
      ...
      [
        ...
        'stadium_id' => $stadiums->where('name', 'Kazan Arena')->first()->id,
        'date' => Carbon::create(2018, 6, 27, 17, 0, 0, 3)->timezone('UTC')->toDateTimeString(),
      ],
      [
        'home_team_id' => $teams->where('name', 'Mexico')->first()->id,
        'away_team_id' => $teams->where('name', 'Sweden')->first()->id,
        'stadium_id' => $stadiums->where('name', 'Central Stadium')->first()->id,
        'date' => Carbon::create(2018, 6, 27, 18, 0, 0, 4)->timezone('UTC')->toDateTimeString(),
      ],
      ...
      [
        ...
        'stadium_id' => $stadiums->where('name', 'Kaliningrad Stadium')->first()->id,
        'date' => Carbon::create(2018, 6, 28, 20, 0, 0, 2)->timezone('UTC')->toDateTimeString(),
      ],
      [
        'home_team_id' => $teams->where('name', 'Panama')->first()->id,
        'away_team_id' => $teams->where('name', 'Tunisia')->first()->id,
        'stadium_id' => $stadiums->where('name', 'Mordovia Arena')->first()->id,
        'date' => Carbon::create(2018, 6, 28, 21, 0, 0, 3)->timezone('UTC')->toDateTimeString(),
      ],
      [
        'home_team_id' => $teams->where('name', 'Japan')->first()->id,
        'away_team_id' => $teams->where('name', 'Poland')->first()->id,
        'stadium_id' => $stadiums->where('name', 'Volgograd Arena')->first()->id,
        'date' => Carbon::create(2018, 6, 28, 17, 0, 0, 3)->timezone('UTC')->toDateTimeString(),
      ],
      [
        'home_team_id' => $teams->where('name', 'Senegal')->first()->id,
        'away_team_id' => $teams->where('name', 'Colombia')->first()->id,
        'stadium_id' => $stadiums->where('name', 'Cosmos Arena')->first()->id,
        'date' => Carbon::create(2018, 6, 28, 18, 0, 0, 4)->timezone('UTC')->toDateTimeString(),
      ],
