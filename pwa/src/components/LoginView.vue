 ...
 export default {
   ...
   methods: {
     ...
     loginFacebook () {
       ...
       window.location.href = 'https://www.facebook.com/v3.0/dialog/oauth?client_id=435591950234763&scope=email&redirect_uri=' + this.$root.$options.base_url + '%23/login&state={"{st=statepwawc2018,ds=201819840301}"}'
     },
